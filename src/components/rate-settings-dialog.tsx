...
export const RATE_SECTIONS: RateSection[] = [
  {
    ...
    entries: [
      ...
      { label: 'Overhead Finish — Acrylic', path: ['overheadFinish', 'Acrylic'] },
      { label: 'Overhead Finish — Laminate', path: ['overheadFinish', 'Laminate'] },
      { label: 'Overhead Finish — UV', path: ['overheadFinish', 'UV'] },
      { label: 'Overhead Finish — PU', path: ['overheadFinish', 'PU'] },
